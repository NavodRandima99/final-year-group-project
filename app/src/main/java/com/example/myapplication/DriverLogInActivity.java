...
public class DriverLogInActivity extends AppCompatActivity {
 private Button mLogin , mRegistertion , mGoBack ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //police stattions
        String[] policeStations = {"Select your police station","14 Miles(Govindapura)" , "Achchuweli" , "Agarapathana" , "Agbopura" , "Ahangama" , "Ahungalla" ,  "Aiththamalai" , "Akkaraipattu" ,
                "Akkarayamkulam" , "Akmeemana" , "Akuressa" , "Alawathugoda" , "Alawwa" , "Aluthgama" , "Ambalangoda" , "Ambalantota" , "Ambanpola" , "Ampara" , "Anamaduwa" , "Angulana" ,
                "Angunakolapelessa" , "Anguruwatota" , "Ankumbura" , "Anuradapura" , "Arachchikattuwa" , "Aralaganwila" , "Aranayaka" , "Athimale" , "Athurugiriya" , "Awissawella" , "Ayagama" ,
                "Badalkumbura" , "Baddegama" , "Badulla" , "Baduraliya" , "Bakamuna" , "Bakkiella" , "Balangoda" , "Bambalapitiya" , "Bandaragama" , "Bandarawela" , "Batticaloa" , "Beliatta" ,
                "Bentota" , "Beruwala" , "Bibila" , "Bingiriya" , "Biyagama" , "Bluemandal" ,"BMICH" , "Bogahakumbura" , "Bogaswewa" , "Bogawanthalawa" , "Boralesgamuwa" , "Borella" , "Bulathkohupitiya" ,
                "Bulathsinhala" , "Buttala" , "Central Camp" , "Chawakachcheri" , "Chawalakade" , "Chettikulam" , "Chilaw" , "Chinabay" , "Chunnakam" , "Cinnamon Garden" , "Colombo Harbour" , "Dalada Maligawa" ,
                "Dam Street" , "Damana" , "Dambagalla" , "Dambulla" , "Dankotuwa" , "Daulagala" , "Dayagama" , "Dedigama" , "Dehiaththakandiya" , "Dehiwala" , "Delft" , "Dematagoda" , "Deniyaya" ,
                "Deraniyagala" , "Deyyandara" , "Dharmapuram" , "Dikwella" , "Dimbulapathana" , "Diulapitiya" , "Diyathalawa" , "Dodangoda" , "Dompe" , "Dummalasooriya" , "Dungalpitiya" ,"Echchanmkulam" ,
                "Egoda Uyana" , "Ehaliyagoda" , "Ella" , "Elpitiya" , "Embilipitiya" , "Eppawala" , "Eravur" , "Etempitiyav" , "Fore shore" , "Fort" , "Galagedara" , "Galaha" , "Galenbidunuwewa" ,
                "Galewela" , "Galgamuwa" , "Galkiriyagama" , "Galle Harbour" , "Galle" , "Galnewa" , "Gampaha" , "Gampola" , "Gandara" , "Ganemulla" , "Ginigathhena" , "Giradurukotte" , "Giribawa" ,
                "Giriulla" , "Godakawela" , "Gokarella" , "Gomarankadawala" , "Gonaganara" , "Gothatuwa" , "Grandpass" , "Habaraduwa" , "Habarana" , "Hakmana" , "Haliela" , "Hambantota" , "Hambegamuwa" ,
                "Hanguranketha" , "Hanwella" , "Haputale" , "Hasalaka" , "Hatharaliyadda" , "Hatton" , "Hemmathagama" , "Hettipola" , "Hidogama" , "Hikkaduwa" , "Hingurakgoda" , "Hiniduma" , "Homagama" ,
                "Horana" , "Horowpathana" , "Hungama" , "Ilavalai" , "Iluppakadawai" , "Imaduwa" , "Inginiyagala" , "Ingiriya" , "Ipalogama" , "Irattaperiyakulam" , "Ja – Ela" , "Jaffna" , "Kadawatha" ,
                "Kadugannawa" , "Kahatagasdigiliya" , "Kahathuduwa" , "Kahawatta" , "Kalawana" , "Kalawanchikudy" , "Kalkudah" , "Kalmunai" , "Kalpitiya" , "Kaltota" , "Kalutara North" , "Kalutara South" ,
                "Kamburupitiya" , "Kanagarayankulam" ,"Kananke" , "Kandaketiya" , "Kandana" , "Kandapola" , "Kandy" , "Kankasanthurai" , "Kantale" , "Karadiyanaru" , "Karandeniya" , "Karandugala" ,
                "Karuwalagaswewa" , "Katana" , "Kataragama" , "Kaththankudi" , "Katugastota" , "Katunayaka" , "Katupotha" , "Katuwana" , "Kayts" , "Kebithigollawa" , "Kegalle" , "Kekirawa" , "Kelaniya" ,
                "Keselwatta" , "Kilinochchi" , "Kinnia" , "Kiribathgoda" , "Kiriella" , "Kirinda" , "Kirindiwela" , "Kirulapone" , "Kithulgala" , "Kobeigane" , "Kochchikade" , "Kodikamam" , "Kohuwala" ,
                "Kokkadicholai" , "Kollupitiya" , "Kolonna" , "Kopai" , "Kosgama" , "Kosgoda" , "Koslanda" , "Kosmodara" , "Koswatta" , "Kotadeniyawa" , "Kotahena" , "Kotawehera" , "Kotawila" , "Kotmale" ,
                "Kottawa" , "Kuchchaweli" , "Kudaoya" , "Kuliyapitiya" , "Kumbukgatey" , "Kurunegala" , "Kuruwita" , "Kuttigala" , "Laggala" , "Lindula" , "Lunugala" , "Lunugamwehera" , "Madampe" , "Madolseema" ,
                "Madu" , "Mahabage" , "Mahakalugolla" , "Mahaoya" , "Maharagama" , "Mahawela" , "Mahawilachchiya" , "Mahiyangane" , "Maho" , "Maligawatta" , "Malimbada" , "Mallavi" , "Malwathuhiripitiya" ,
                "Ma-Maduwa" , "Mandaram Nuwara" , "Mangalagama" , "Manikhinna" , "Manippai" , "Mankulam" , "Mannar" , "Maradana" , "Marawila" , "Maskeliya" , "Matale" , "Matara" , "Mathugama" , "Mattakkuliya" ,
                "Mattegoda" , "Maturata" , "Mawanella" , "Mawarala" , "Mawathagama" , "Medagama" , "Medawachchiya" , "Medirigiriya" , "Meegahathenna" , "Meegahawatta" , "Meegalewa" , "Meepe" , "Meerigama" ,
                "Meetiyagoda" , "Middeniya" , "Mihintale" , "Millaniya" , "Minneriya" , "Minuwangoda" , "Mirihana" , "Modara" , "Monaragala" , "Moragahahena" , "Moragoda" , "Moratumulla" , "Moratuwa" ,
                "Morawaka" , "Morawewa" , "Moronthuduwa" , "Mount Lavinia" , "Mulankavil" , "Muliyaweli" , "Mullativu" , "Mulleriyawa" , "Mundal" , "Murunkan" , "Mutur" ,"Nachchikudha" , "Nagoda" ,
                "Nallathanni" , "Nanuoya" , "Narahenpita" , "Narammala" , "Naula" , "Nawa Kurunduwatta" , "Nawagamuwa" , "Nawagaththegama" , "Nawalapitiya" , "Nedumkenrni" , "Negombo" , "Nelliadi" ,
                "Neluwa" , "Nikaweratiya" , "Nilawely" , "Nittambuwa" , "Nivithigala" , "Nochchiyagama" , "Norochcholey" , "Nortonbridge" , "Norwood" , "Nuwaraeliya" , "Oddusudan" , "Okkampitiya" , "Omantha" ,
                "Opanayaka" , "Padaviya" , "Padiyathalawa" , "Padukka" , "Palali" , "Palei" , "Pallama" , "Pallekele" , "Pallewela" , "Pamunugama" , "Panadura North" , "Panadura South" , "Panama" , "Panamure" ,
                "Pannala" , "Panwila" , "Parasangaswewa" , "Parayanakulam" , "Passara" , "Pattipola" , "Payagala" , "Peliyagoda" , "Pelmadulla" , "Peradeniya" , "Pesale 071" , "Pettah" , "Piliyandala" ,
                "Pindeniya" , "Pinnawala" , "Pitabeddara" , "Pitigala" , "Poddala" , "Point Pedro" , "Polgahawela" , "Polonnaruwa" , "Polpithigama" , "Poojapitiya" , "Pothuhera" , "Pothuvil" , "Pudalu oya" ,
                "Pudukuduiruppu" , "Pugoda" , "Pulasthipura" , "Puliyankulam" , "Pulmudai" , "Punarin" , "Pussellawa" , "Puttalam" , "Puwarasamkulam" , "Raddolugama" , "Ragala" , "Ragama" , "Rajanganaya" ,
                "Rakwana" , "Rambukkana" , "Rangala" , "Rasnayakapura" , "Ratgama" , "Ratnapura" , "Rattota" , "Redeemaliyadda / (Kanugolla)" , "Rideegama" , "Rotumba" , "Ruwanwella" , "Saliyawewa" , "Samanthurai" ,
                "Sampoor" , "Sapugaskanda" , "Seeduwa" , "Serunuwara" , "Sewanagala" , "Sigiriya" , "Silawathura" , "Siripagama" , "Siyambalanduwa" , "Slave Island" , "Sooriyawewa" , "Sripura" , "Suriyapura" ,
                "Tangalle" , "Thalaimannar" , "Thalangama" , "Thalathuoya" , "Thalawa" , "Thalawakale" , "Thambalagamuva" , "Thambuttegama" , "Thanamalwila" , "Thanthirimalaya" , "Thebuwana" , "Theldeniya" ,
                "Thelikada" , "Thelippalay" , "Theripaha" , "Thihagoda" , "Thiniyawala" , "Thirappone" , "Thirukkovil" , "Tissamaharamaya" , "Trinco Harbour Police" , "Trincomalee" , "Udamaluwa" , "Udappuwa" ,
                "Udawalawa" , "Ududumbara" , "Udugama" , "Udupussellawa" , "Uhana" , "Ulukkulam" , "Uppuweli" , "Uragasmanhandiya" , "Urubokka" , "Uvaparanagama" , "Vaddukoddai" , "Valachchanai" ,
                "Valvettiththurai" , "Vavunathive" , "Vavuniya" , "Vellavali" , "Wadduwa" , "Wakarai" , "Walapone" , "Walasmulla" , "Wan Ela" , "Wanathawilluwa" , "Wanduramba" , "Wankala" , "Wariyapola" ,
                "Watawala" , "Wattala" , "Wattegama" , "Wedithalathiu" , "Weeragula" , "Weeraketiya" , "Weerambugedara" , "Weeravila" , "Welambada" , "Weligama" , "Weligepola" , "Welikada" , "Welikanda" ,
                "Welimada" , "Welioya" , "Welipanna" , "Weliweriya" , "Wellampitiya" , "Wellawa" , "Wellawatta" , "Wellawaya" , "Wennappuwa" , "Wewalwatta" , "Weyangoda" , "Wilgamuwa" , "Wolfendhal Street" ,
                "Wrakapola" , "Yakkala" , "Yakkalamulla" , "Yatawatta" , "Yatiyantota"
        };
